...
const {author_name,book_name,picture,date_published,user_name} = req.body
    connection.query(`INSERT INTO books (author_name, book_name, picture, date_published, user_name) VALUES (${author_name},${book_name},${picture},${}) `,[req.body.author_name, req.body.book_name, req.body.picture, req.body.date_published, req.body.user_name], function (err, results) {
        if (err) throw err;
        console.log(results);
    });
});
