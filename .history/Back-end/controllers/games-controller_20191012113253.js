...
router.post('/games/unproductive', async function (req, res) {

    connection.query(`INSERT INTO favorites_games (game_name, background_image, released_date, genre, user_name)
