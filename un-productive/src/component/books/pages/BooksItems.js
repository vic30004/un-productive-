        ...
        <div className="App">
          <header className="App-header">
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent:'center', marginTop: '30px'}}>
              ...
              {this.state.slideCount !== (this.state.photos.lenght -1)? <NextArrow nextImage={this.nextImage}/>:''}</div>
              ...
              const BackArrow={props} => (
                <div onClick={props.previousImage} style={{fonzise: '2em',marginRight:'12px'}}>
                  <i className="fa fa-angle-left fa-2x" aria-hidden="true"></i>
                </div>
              )
              ...
              this.nextImage-this.nextImage.bin(this);
